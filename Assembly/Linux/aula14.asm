...
; novaLinha:  db  LF    ; linha desnecessária

;variavel: times 15 db 'X'           ;variavel:   db 'XXXXXXXXXXXXXXX'
...
_start:
    ...
    mov ecx, variavel
    mov edx, 15         ; sempre 15 ; mov edx, variavel_len; hardcoded
    call leitura
    ...
    mov ecx, variavel
    mov edx, 15         ; sempre 15 ; mov edx, variavel_len
    call escrita

    mov eax, SYS_EXIT   ; 2 linhas 'economizadas': 'jmp saida' e 'saida:'
