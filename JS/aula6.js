...
let nome = ''               /* declaração obrigatória   // = '' evita undefined */

console.log(`${GREEN}==========LITERAIS, CONSTANTES E VARIÁVEIS==========${RESET}`)

console.log('\n1 - Literal clássico helloworld:')
console.log(`${INVERT}Oi, mundo!${RESET}`)

console.log('\n2 - Valor std da variável antes da inicialização:')
function mostrarNome(){         // Definição de função (não executa aqui - apenas define)
...
nome=process.argv[2] || ''                  // || '' evita undefined
